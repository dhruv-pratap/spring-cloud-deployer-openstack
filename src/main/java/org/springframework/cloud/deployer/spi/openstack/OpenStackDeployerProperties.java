 ...
 */
@ConfigurationProperties(prefix = "spring.cloud.deployer.openstack")
public class OpenStackDeployerProperties {
	 ...
	 *
	 * @deprecated Use spring.cloud.deployer.openstack.limits.memory
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated Use spring.cloud.deployer.openstack.limits.cpu
	 */
	@Deprecated
